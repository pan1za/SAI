            ...
            <tbody align="center">
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="editarEntrada.php?idEntrada=<?php echo $row['idEntrada']?>" class="btn btn-secondary">
                            ...
                            <a href="eliminarProducto.php?idEntrada=<?php echo $row['idEntrada']?>" class="btn btn-danger">
