...
<main class="container p-4">
    <h3 class="offset-4 col-10">Lista de todos los productos</h3><br>
    <div class="w-50 card-body offset-3">
        <table class="table table-bordered">
            ...
            <tbody align="center">
                <?php foreach ($conn->query("SELECT p.idProducto, p.nombreProducto, p.unidadMedida, s.nombre from productos p INNER JOIN sede s ON s.idSede = p.idSede") as $row) {
                ?>
                    <tr>
